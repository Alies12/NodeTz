import { IFigure, FigureId, FigureType, FigureParameters } from '../core/interfaces';
...
export abstract class BaseFigure extends EventTarget implements IFigure {
     ...
     * @protected
     */
    protected _dispatchPropertyChange(property: string, oldValue: any, newValue: any): void {
        if (oldValue !== newValue) {
            this.dispatchEvent(new FigurePropertyChangeEvent(property, oldValue, newValue));
        }
    }
}